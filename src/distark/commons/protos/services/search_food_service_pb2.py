...
# source: services/search_food_service.proto
...
_PBSEARCHFOODERRORS = _descriptor.EnumDescriptor(
...
PBSearchFoodErrors = enum_type_wrapper.EnumTypeWrapper(_PBSEARCHFOODERRORS)
ERROR_NONE = 1
ERROR_NO_RESULT = 2
ERROR_OTHER = 3
...
_PBSEARCHFOODREQUEST = _descriptor.Descriptor(
...
_PBSEARCHFOODRESPONSE = _descriptor.Descriptor(
